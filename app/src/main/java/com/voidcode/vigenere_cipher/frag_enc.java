...
public class frag_enc extends Fragment {

    Button encrypt, options;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState){
        View view = inflater.inflate(R.layout.frag_enc, container, false);

        encrypt = view.findViewById(R.id.encrypt);
        options = view.findViewById(R.id.options_e);

        input = view.findViewById(R.id.input_e);
        key = view.findViewById(R.id.key_e);
        output = view.findViewById(R.id.output_e);

        copy_in = view.findViewById(R.id.copy_in_e);
        copy_out = view.findViewById(R.id.copy_out_e);
        paste_in = view.findViewById(R.id.paste_in_e);
        paste_out = view.findViewById(R.id.paste_out_e);
    ...
    public void onActivityCreated(Bundle savedInstanceState){
        ...
        encrypt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!key_str.equals("")) result = cipher.encrypt(input_text, key_str);
